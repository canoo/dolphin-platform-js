...
var BlindCommandBatcher = function () {
    ...
    _createClass(BlindCommandBatcher, [{
        ...
        value: function batch(queue) {
            console.log("batch in: " + queue.lenght);
            var batch = [];
            var batchLenght = 0;
            while (queue[batchLenght] && batchLenght <= this.maxBatchSize) {
                var element = queue[batchLenght];
                batchLenght++;
                if (this.folding) {
            ...
            console.log("batch out: " + batch.lenght);
            return batch;
        }
    }]);
